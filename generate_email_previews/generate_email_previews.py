...
def generate_previews():
    ...
    test_cases = [
        ...
        ('notification', [name, target_email, "Security Update", "Please review your account security settings.", "🔒", "Update Now", "https://victor-kipruto-rop.github.io/victor-resum-web/dashboard/login/"]),
