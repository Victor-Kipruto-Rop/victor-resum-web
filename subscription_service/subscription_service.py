    ...
    def _send_email_notification(self, subscriber: Dict, post_data: Dict) -> bool:
        ...
        try:
            ...
            notification_data = {
                ...
                "url": post_data.get("url", f"https://victor-kipruto-rop.github.io/victor-resum-web/post/?id={post_data.get('id', 'post')}"),
...
def main():
    ...
    if args.action == "subscribe":
        ...
        post_data = {
            ...
            "url": args.post_url or "https://victor-kipruto-rop.github.io/victor-resum-web/blog/",
