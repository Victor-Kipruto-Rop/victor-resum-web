...
main() {
    ...
    BLOG_AI_DIR="$RESUME_DIR/ops/blog-ai"
...
EOF
    ...
    python3 "$RESUME_DIR/ops/tools/test_system.py"
    ...
    echo "   file://$RESUME_DIR/public/subscribe/index.html"
    echo ""
    echo "5. Deploy to GitHub:"
    echo "   cd $RESUME_DIR"
    echo "   bash ops/blog-ai/push.sh 'Initial Blog AI setup'"
    echo ""
