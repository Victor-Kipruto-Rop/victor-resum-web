...
def demo_file_structure():
    ...
    print("├── content/ai-generated/        - Generated markdown posts")
...
def main():
    ...
    1. Configure API Keys:
       cp ops/blog-ai/.env.example ops/blog-ai/.env
       nano ops/blog-ai/.env  # Add your API keys
    
    2. Install Dependencies:
       pip install -r ops/blog-ai/requirements.txt
