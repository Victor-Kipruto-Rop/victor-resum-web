...
def show_summary():
    ...
    for num, filename, description in emails:
        file_path = test_dir / f'{filename}_20260607_181311.html'
        if file_path.exists():
...
3. Run the send script with the API key configured:
   RESEND_API_KEY='re_...' python3 ops/tools/send_all_test_emails.py
...
Emails saved as: Test HTML files for manual inspection
    ...
    welcome_file = test_dir / 'welcome_20260607_181311.html'
...
2. Double-click any .html file to preview:
   - welcome_20260607_181311.html
   - new_blog_post_20260607_181311.html
   - weekly_digest_20260607_181311.html
   - etc.

3. All emails include:
   - Modern design matching blog.html
