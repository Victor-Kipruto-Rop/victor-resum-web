...
class GitHubSetupVerifier:
    def __init__(self, root_path="."):
        ...
        self.scripts_path = self.root / "ops" / "scripts" / "python"
        self.errors = []
        self.warnings = []
        self.passed = []
    ...
    def check_script_references(self):
        ...
        required_scripts = {
            ...
            'ops/scripts/python/generate_blog.py',
            'ops/scripts/python/generate_rss.py',
            'ops/scripts/python/generate_sitemap.py',
            'ops/scripts/python/generate_seo.py',
            'ops/scripts/python/generate_performance_scores.py',
            'ops/scripts/python/generate_content_strategy.py',
            'ops/scripts/python/generate_distribution.py',
            
            # Image processing
            'ops/scripts/python/auto_image_assigner.py',
            'ops/scripts/python/image_library_manager.py',
            'ops/scripts/python/image_selector.py',
            
            # Notifications
            'ops/scripts/python/notify_telegram.py',
            'ops/scripts/python/notify_email.py',
            'ops/scripts/python/notify_recruiter.py',
            'ops/scripts/python/notify_seo.py',
            'ops/scripts/python/notify_viral.py',
            
            # Detection & Analysis
            'ops/scripts/python/parse_blog_changes.py',
            'ops/scripts/python/recruiter_detector.py',
            'ops/scripts/python/viral_detector.py',
            'ops/scripts/python/event_detection.py',
            'ops/scripts/python/subscriber_segmentation.py',
            
            # Logging
            'ops/scripts/python/log_notification.py',
            
            # Automation
            'ops/automation/notifier.py',
        }
