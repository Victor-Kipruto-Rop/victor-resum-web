...
─────────────────────────────────────────────────────────────────────────────
  📧 Email:       subscribe.html (with email form & localStorage)
  🔄 RSS:         subscribe-rss.html (with feed discovery)
  📡 Feed:        feed.xml (3 blog items, RSS 2.0 format)
  🔗 Integration: Cross-links between email and RSS ✅
  📊 Analytics:   subscription-analytics-dashboard.html
  🧪 Tests:       8/8 PASSING ✅
...
─────────────────────────────────────────────────────────────────────────────
  Initialize database:
    $ python3 ops/tools/database.py

  Test subscriptions:
    $ python3 ops/tools/test_subscriptions.py

  Test dashboards:
    $ python3 ops/tools/test_dashboards.py

  Harden security:
    $ python3 ops/tools/harden_dashboard_security.py
