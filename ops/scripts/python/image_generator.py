...
class AIImageGenerator:
    ...
    def __init__(self):
        ...
        self.output_dir = Path("public/assets/auto/generated")
        self.output_dir.mkdir(parents=True, exist_ok=True)
        
        self.generation_log_file = Path("public/assets/auto/generation-log.json")
        self.image_mapping_file = Path("public/assets/auto/generated-images.json")
