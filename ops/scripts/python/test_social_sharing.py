...
def test_manual_sharing():
    """Test manual share buttons on post.html"""
    print("\n" + "="*70)
...
def test_auto_social_posting():
    ...
    try:
        ...
        print("\n⚙️  Configuration:")
        config_file = Path("ops/social-automation/config.json")
...
def test_integration():
    ...
    print("""
When you run: python ops/scripts/python/blog_notifier.py notify-posts
...
2️⃣  Send Email + Auto-post to Socials:
    python3 ops/scripts/python/blog_notifier.py notify-posts
    
    This will:
    ✅ Send emails to subscribers (public/blog/posts.json posts with featured images)
...
3️⃣  Check Social Platform Status:
    python3 ops/scripts/python/auto_social_poster.py status
    
    Shows which platforms are connected and ready

4️⃣  Post Specific Blog to Socials:
    python3 ops/scripts/python/auto_social_poster.py post <slug>
    
    Example:
    python3 ops/scripts/python/auto_social_poster.py post kubernetes-patterns

5️⃣  Add Email Subscriber (for testing):
    The /subscribe.html page has a form where users can subscribe
    Or manually add to subscribers.json:
    {
      "subscribers": [
        {
...
6️⃣  View Auto-Posting Log:
    cat ops/scripts/python/.social_posts.json
...
def show_file_locations():
    ...
    print("""
Blog Posts:
  📝 public/blog/posts.json              - Your autogenerated blog posts with images
  🖼️  assets/images/*.png        - Blog post featured images (1200x630px)

Blog Pages:
  🏠 blog.html                    - Blog listing page
  📄 post.html                    - Individual post view + share buttons
  ✉️  subscribe.html              - Email subscription form

Email System:
  📧 ops/scripts/python/email_templates.py         - 6 email template designs
  📧 ops/scripts/python/email_template_manager.py  - Email sending manager
  📧 ops/scripts/python/subscription_handler.py    - Subscriber management

Blog Notifications:
  📬 ops/scripts/python/blog_notifier.py           - Email notifications + social posting
  📬 ops/scripts/python/.blog_events.json          - Tracks which posts were notified

Social Media:
  📱 ops/scripts/python/auto_social_poster.py      - Automatic social posting orchestrator
  📱 ops/scripts/python/.social_posts.json         - Tracks which posts were shared on each platform
  📱 ops/social-automation/dispatcher.py           - Social media dispatcher
  📱 ops/social-automation/config.json             - Platform credentials & settings
  📱 ops/social-automation/twitter.py              - Twitter/X posting
  📱 ops/social-automation/linkedin.py             - LinkedIn posting
  📱 ops/social-automation/devto.py                - Dev.to posting
  📱 ops/social-automation/medium.py               - Medium posting
  📱 ops/social-automation/telegram.py             - Telegram posting
...
def verify_setup():
    ...
    checks = {
        "public/blog/posts.json": "Blog posts file",
        "public/assets/images/": "Blog post images",
        "public/blog/index.html": "Blog listing page",
        "public/post/index.html": "Blog post page with share buttons",
        "public/subscribe/index.html": "Email subscription form",
        "ops/scripts/python/blog_notifier.py": "Blog notifier",
        "ops/scripts/python/auto_social_poster.py": "Auto social poster",
        "ops/scripts/python/email_templates.py": "Email templates",
        "ops/social-automation/config.json": "Social media config"
    }
...
Next Steps:
  ...
  3. Run: python3 ops/scripts/python/blog_notifier.py notify-posts
...
For Questions or Issues:
  ...
  • Review ops/social-automation/config.json for platform settings
    """)
