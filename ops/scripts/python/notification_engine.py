...
class NotificationEngine:
    ...
    def __init__(self):
        ...
        self.logs_file = Path('ops/notifications/notification-logs.json')
        self.alerts_file = Path('ops/notifications/alerts-queue.json')
        self.config_file = Path('ops/notifications/notification-config.json')
