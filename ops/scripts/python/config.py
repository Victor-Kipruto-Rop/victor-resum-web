...
class Config:
    ...
    POSTS_FILE = 'public/blog/posts.json'
    RENDERED_DIR = 'public/blog/rendered'
    CONTENT_DIR = 'content'
    ASSETS_DIR = 'public/assets'
    DASHBOARD_DIR = 'dashboard'
    SECURITY_DIR = 'security'
    ANALYTICS_DIR = 'ops/analytics'
    STRATEGY_DIR = 'ops/strategy'
    DISTRIBUTION_DIR = 'ops/distribution'
