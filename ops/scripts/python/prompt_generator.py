...
class AIPromptGenerator:
    ...
    def __init__(self):
        self.analysis_file = Path("public/assets/auto/content-analysis.json")
        self.prompts_file = Path("public/assets/auto/generated-prompts.json")
...
""".strip()
    ...
    def generate_all_prompts(self) -> Dict[str, Dict]:
        ...
        prompts_data = {
            "generated_at": Path("public/assets/auto/generated-prompts.json").stem,
