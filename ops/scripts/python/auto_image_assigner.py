...
class AutoImageAssigner:
    ...
    def __init__(self):
        ...
        self.posts_file = Path('public/blog/posts.json')
        self.assignment_log_file = Path('public/assets/auto/assignment-log.json')
        self.social_metadata_file = Path('public/assets/auto/social-metadata.json')
