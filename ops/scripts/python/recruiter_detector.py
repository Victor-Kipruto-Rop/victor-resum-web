...
class RecruiterDetector:
    ...
    def __init__(self):
        self.history_file = Path('ops/analytics/recruiter-history.json')
        self.visitor_file = Path('ops/analytics/visitor-activity.json')
    ...
    def run(self):
        ...
        # Save results
        output_file = Path('ops/analytics/recruiter-analysis.json')
        ...
        report_file = Path('ops/analytics/recruiter-report.json')
