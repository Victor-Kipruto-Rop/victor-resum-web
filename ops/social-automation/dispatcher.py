...
class SocialDispatcher:
    ...
    def dispatch_from_metadata(self, metadata_path: str) -> Dict:
        ...
        try:
            ...
            markdown_path = f"content/ai-generated/{post_id}.md"
    ...
    def _save_dispatch_result(self, results: Dict):
        ...
        log_path = Path("ops/dispatch_logs")
...
def main():
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == "--dispatch-file":
            filepath = sys.argv[2] if len(sys.argv) > 2 else "content/ai-generated/latest.md"
            results = dispatcher.dispatch_from_file(filepath)
            print(json.dumps(results, indent=2))

        elif sys.argv[1] == "--dispatch-metadata":
            metadata_path = sys.argv[2] if len(sys.argv) > 2 else "content/ai-generated/latest.meta.json"
