...
2️⃣  Send Email + Auto-post to Socials:
    ...
    This will:
    ✅ Send emails to subscribers (blog/posts.json posts with featured images)
...
def show_file_locations():
    ...
    print("""
Blog Posts:
  📝 blog/posts.json              - Your autogenerated blog posts with images
...
Blog Notifications:
  ...
  📬 scripts/python/.blog_events.json          - Tracks which posts were notified

Social Media:
  📱 scripts/python/auto_social_poster.py      - Automatic social posting orchestrator
  📱 scripts/python/.social_posts.json         - Tracks which posts were shared on each platform
...
def verify_setup():
    ...
    checks = {
        "blog/posts.json": "Blog posts file",
        "assets/images/": "Blog post images",
        "blog.html": "Blog listing page",
        "post.html": "Blog post page with share buttons",
