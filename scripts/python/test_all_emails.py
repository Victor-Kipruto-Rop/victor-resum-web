    ...
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0f1419; color: #e8eef5; border-radius: 16px; overflow: hidden;">
        ...
        <div style="padding: 40px;">
            ...
            <div style="text-align: center; margin: 36px 0;">
                <a href="https://victor-kipruto-rop.github.io/victor-resum-web/blog/" style="display: inline-block; padding: 16px 32px; background: #ff4b2b; color: white; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 15px;">Read the Blog →</a>
            </div>
...
def new_post_html():
    ...
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0f1419; color: #e8eef5; border-radius: 16px; overflow: hidden;">
        ...
        <div style="padding: 40px;">
            ...
            <div style="text-align: center; margin: 36px 0;">
                <a href="https://victor-kipruto-rop.github.io/victor-resum-web/blog/" style="display: inline-block; padding: 16px 32px; background: #ff4b2b; color: white; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 15px;">Read Article →</a>
            </div>
...
def custom_html():
    ...
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0f1419; color: #e8eef5; border-radius: 16px; overflow: hidden;">
        ...
        <div style="padding: 40px;">
            ...
            <div style="text-align: center; margin: 36px 0;">
                <a href="https://victor-kipruto-rop.github.io/victor-resum-web/dashboard/blog-operations-center/" style="display: inline-block; padding: 16px 32px; background: #3b82f6; color: white; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 15px;">Open Dashboard →</a>
            </div>
...
def admin_alert_html():
    ...
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0f1419; color: #e8eef5; border-radius: 16px; overflow: hidden;">
        ...
        <div style="padding: 40px;">
            ...
            <div style="text-align: center; margin: 36px 0;">
                <a href="https://victor-kipruto-rop.github.io/victor-resum-web/dashboard/blog-operations-center/" style="display: inline-block; padding: 16px 32px; background: #f59e0b; color: #0f1419; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 15px;">View Dashboard →</a>
            </div>
...
def weekly_digest_html():
    ...
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0f1419; color: #e8eef5; border-radius: 16px; overflow: hidden;">
        ...
        <div style="padding: 40px;">
            ...
            <div style="text-align: center; margin: 36px 0;">
                <a href="https://victor-kipruto-rop.github.io/victor-resum-web/blog/" style="display: inline-block; padding: 16px 32px; background: #10b981; color: white; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 15px;">View All Posts →</a>
            </div>
