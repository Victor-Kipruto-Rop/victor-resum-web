...
def test_all_emails(target_email):
    ...
    test_cases = [
        ...
        ('notification', "System Notification", [name, target_email, "Security Update", "Please review your account security settings.", "🔒", "Update Now", "https://victor-kipruto-rop.github.io/victor-resum-web/dashboard/login/"]),
